...
const DEFAULT_KNOWLEDGE_BASE = [
  ...
  // ============ B2C产品 ============
  {
    ...
    shortName: '2Cshop商城站',
    price: '3800-16800',
    priceDisplay: '基础版 ¥3,800 / 精英版 ¥5,800（爆款）/ 品牌版 ¥8,800（爆款）/ 尊享版 ¥16,800',
    priceType: 'tiered',
    priceDetail: '基础版3,800/精英版5,800/品牌版8,800/尊享版16,800；次年续费：基础版3,800、精英版4,800、品牌版4,800、尊享版4,800',
    keywords: ['B2C', '跨境电商', '电商', '商城站', '2Cshop', '独立站商城', 'DTC', 'shopify', '建站', 'PayPal', 'Facebook电商', 'TikTok电商'],
    targetCustomer: '跨境电商卖家、B2C品牌出海企业，需要建立独立商城站',
    features: [
      '【版本选择】基础版(¥3,800) / 精英版(¥5,800，爆款) / 品牌版(¥8,800，爆款) / 尊享版(¥16,800)',
      '【基础版】新手入门类卖家，低成本学习上手',
      '【精英版·爆款】绝佳的启动方式，可以完全满足使用',
      '【品牌版·爆款】初具团队规模卖家，轻松衡量品牌攀升',
      '【尊享版】适合企业卖家，赋能海外DTC业务',
      '【次年续费】基础版¥3,800、精英版¥4,800、品牌版¥4,800、尊享版¥4,800',
      '【支付集成】PayPal集成',
    ...
    description: '【2Cshop 跨境电商建站】专注B2C跨境电商独立商城站建设。四档版本满足不同阶段需求：基础版（入门级）/精英版（启动款，爆款）/品牌版（团队级，爆款）/尊享版（企业DTC级）。次年续费基础版不变，精英版及以上统一¥4,800/年。支持PayPal支付、与ERP集成、对接Facebook/Instagram/TikTok/Google等广告平台。',
